...
| 规范分类 | 规范名称 | 规范说明 |
|---------|---------|---------|
| 运维模板 | [实施计划模板](./03_项目运维/30_运维模板/实施计划模板.md) | 项目实施计划的模板文档 |
| | [测试报告模板](./03_项目运维/30_运维模板/测试报告模板.md) | 测试报告的模板文档 |
| | [规格文档模板](./03_项目运维/30_运维模板/规格文档模板.md) | 技术规格文档的模板 |
| | [需求文档模板](./03_项目运维/30_运维模板/需求文档模板.md) | 需求文档的模板文档 |
| 需求管理 | [移除智能截图工具功能](./03_项目运维/31_需求文档/移除智能截图工具功能.md) | 移除智能截图工具的需求文档 |
| | [移除聊天记录导出为图片功能](./03_项目运维/31_需求文档/移除聊天记录导出为图片功能.md) | 移除聊天记录导出为图片的需求文档 |
| | [移除会话管理的ZIP导入导出功能](./03_项目运维/31_需求文档/移除会话管理的ZIP导入导出功能.md) | 移除会话管理ZIP导入导出的需求文档 |
| 实施计划 | [移除智能截图工具功能](./03_项目运维/32_实施计划/移除智能截图工具功能.md) | 移除智能截图工具的实施计划 |
| | [移除聊天记录导出为图片功能](./03_项目运维/32_实施计划/移除聊天记录导出为图片功能.md) | 移除聊天记录导出为图片的实施计划 |
| | [移除会话管理的ZIP导入导出功能](./03_项目运维/32_实施计划/移除会话管理的ZIP导入导出功能.md) | 移除会话管理ZIP导入导出的实施计划 |
| 技术规格 | [移除智能截图工具功能](./03_项目运维/33_规格文档/移除智能截图工具功能.md) | 移除智能截图工具的技术规格 |
| | [移除聊天记录导出为图片功能](./03_项目运维/33_规格文档/移除聊天记录导出为图片功能.md) | 移除聊天记录导出为图片的技术规格 |
| | [移除会话管理的ZIP导入导出功能](./03_项目运维/33_规格文档/移除会话管理的ZIP导入导出功能.md) | 移除会话管理ZIP导入导出的技术规格 |
| 测试验证 | [移除智能截图工具功能](./03_项目运维/34_测试报告/移除智能截图工具功能.md) | 移除智能截图工具的测试报告 |
| | [移除聊天记录导出为图片功能](./03_项目运维/34_测试报告/移除聊天记录导出为图片功能.md) | 移除聊天记录导出为图片的测试报告 |
| | [移除会话管理的ZIP导入导出功能](./03_项目运维/34_测试报告/移除会话管理的ZIP导入导出功能.md) | 移除会话管理ZIP导入导出的测试报告 |
| 项目管理 | [任务管理](./03_项目运维/35_项目管理/任务管理.md) | 项目任务管理相关内容 |
| | [资源管理](./03_项目运维/35_项目管理/资源管理.md) | 项目资源管理相关内容 |
| | [项目路线图](./03_项目运维/35_项目管理/项目路线图.md) | 项目实施路线图 |
