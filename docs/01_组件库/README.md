...
| 组件名称 | 组件文档 | 功能说明 |
|---------|---------|---------|
| **ChatWindow** | [聊天窗口](./11_聊天组件/聊天窗口.md) | 主聊天界面 |
| **ChatInput** | [聊天输入框](./11_聊天组件/聊天输入框.md) | 聊天输入框 |
| **ChatMessage** | [聊天消息](./11_聊天组件/聊天消息.md) | 聊天消息展示 |
| **ChatHeader** | [聊天窗口头部](./11_聊天组件/聊天窗口头部.md) | 聊天窗口头部 |
| **ChatMessages** | [聊天消息列表](./11_聊天组件/聊天消息列表.md) | 聊天消息列表 |

### 🪟 弹窗组件

| 组件名称 | 组件文档 | 功能说明 |
|---------|---------|---------|
| **AiSettingsModal** | [AI设置弹窗](./12_弹窗组件/AI设置弹窗.md) | AI 配置弹窗 |
| **TokenSettingsModal** | [令牌设置弹窗](./12_弹窗组件/令牌设置弹窗.md) | Token 设置弹窗 |

### 📦 管理组件

| 组件名称 | 组件文档 | 功能说明 |
|---------|---------|---------|
| **FaqManager** | [FAQ管理器](./13_管理组件/FAQ管理器.md) | FAQ 管理器 |
| **SessionTagManager** | [会话标签管理器](./13_管理组件/会话标签管理器.md) | 会话标签管理器 |
| **FaqTagManager** | [FAQ标签管理器](./13_管理组件/FAQ标签管理器.md) | FAQ 标签管理器 |

### ✏️ 编辑组件

| 组件名称 | 组件文档 | 功能说明 |
|---------|---------|---------|
| **SessionInfoEditor** | [会话信息编辑器](./14_编辑组件/会话信息编辑器.md) | 会话信息编辑器 |

### 🔧 通用组件

| 组件名称 | 组件文档 | 功能说明 |
|---------|---------|---------|
| **LoadingSpinner** | [加载动画](./15_通用组件/加载动画.md) | 加载动画 |
| **Notification** | [通知组件](./15_通用组件/通知组件.md) | 通知组件 |
