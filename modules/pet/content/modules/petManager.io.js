(function () {
  ...
  proto._loadJSZip = async function () {
    ...
    return new Promise((resolve, reject) => {
      ...
      try {
        ...
        loadScriptUrl = getExtensionUrlOrThrow('modules/session/page/load-jszip.js')
      } catch (error) {
        this.jszipLoading = false
  ...
  proto.importSessionsFromZip = async function (file) {
    try {
      ...
      let importScriptUrl
      try {
        importScriptUrl = getExtensionUrlOrThrow('modules/session/page/import-sessions.js')
      } catch (error) {
        const errorMsg = error.message || '扩展上下文无效'
  ...
  proto.exportSessionsToZip = async function () {
    try {
      ...
      let exportScriptUrl
      try {
        exportScriptUrl = getExtensionUrlOrThrow('modules/session/page/export-sessions.js')
      } catch (error) {
        const errorMsg = error.message || '扩展上下文无效'
