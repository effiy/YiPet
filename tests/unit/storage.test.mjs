...
describe('chrome.storage mock', () => {
  it('stores and retrieves values', () => {
    ...
    let result
    chrome.storage.local.get(['key1'], (data) => {
      result = data
    })
  ...
  it('returns undefined for missing keys', () => {
    let result
    chrome.storage.local.get(['nonexistent'], (data) => {
      result = data
    })
  ...
  it('removes keys', () => {
    ...
    let result
    chrome.storage.local.get(['k1', 'k2'], (data) => {
      result = data
    })
...
describe('StorageUtils', () => {
  ...
  describe('saveGlobalState', () => {
    it('saves normalized state with timestamp', async () => {
      ...
      let stored
      chrome.storage.local.get(['petGlobalState'], (data) => {
        stored = data.petGlobalState
      })
